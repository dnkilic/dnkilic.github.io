...
## Student Projects
News with Voice (Sesli Haber), open source speech enabled news application developed by my students.<br/>
Idiot Assistant (Gerzek), open source assistant application for parody purposes developed by my students.<br/>
Global Dictionary, open source dictionary application which can make translation between 21 languages developed by my students.<br/>
